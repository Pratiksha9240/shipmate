    ...
    <>
      <div className="px-16">
        <ul
          ...
          className="relative m-0 flex list-none justify-between overflow-hidden p-0 transition-[height] duration-200 ease-in-out px-24 ml-40 mt-8"
        >
          <li
          ...
          <li data-te-stepper-step-ref className="w-[4.5rem] flex-auto">
            <div>
              <span
                data-te-stepper-head-icon-ref
                className="my-6 mr-2 flex h-[1.938rem] w-[1.938rem] items-center justify-center rounded-full bg-dark-gray text-sm font-medium text-dark-gray"
              >
                4
              </span>
              <p>Booking</p>
      ...
      <Search />
      <div className="mt-8 grid grid-cols-4 px-16">
        <aside
          id="default-sidebar"
        ...
        <div className="block rounded-lg h-[50rem] w-[53rem] bg-gray p-6">
          <div className="block rounded-lg h-[10rem] w-[50rem] bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
            <div className="grid grid-cols-2">
              <div>
                <div className="grid grid-cols-3">
                  <span class="bg-green h-[30px] text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green border border-green">
                    Best Value
                  </span>
                ...
                <div className="grid grid-cols-3">
                  <div className="grid grid-cols-3 mt-5 text-dark-gray">
                  ...
                  <hr className="text-dark-gray mt-8 ml-3" />
                ...
                <div className="grid grid-cols-3">
                  ...
                  <div className="grid grid-cols-5 gap-6 mt-5 text-dark-violet ml-[80px]">
                    <span className="flex-1 ml-3 whitespace-nowrap">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
              ...
              <span className="ml-[200px] border-l-2 h-20">
                <h5 className="mb-2 text-xl ml-10 font-medium leading-tight text-neutral-800 dark:text-neutral-50">
                  $ 3982.63
                </h5>
                <button className="px-2 py-2 w-[100px] ml-10 rounded bg-dark-violet">
                  Select
                </button>
                <br />
          ...
          <div className="block rounded-lg h-[10rem] w-[50rem] bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 mt-8">
            <div className="grid grid-cols-2">
              <div>
                <div className="grid grid-cols-3">
                  <span class="bg-green h-[30px] text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green border border-green">
